  ...
  return (
    <div className="animate-in slide-in-from-bottom-4 duration-500">
      <div className="bg-white rounded-[2.5rem] border border-gray-100 shadow-sm overflow-hidden p-10">
        <h3 className="text-2xl font-bold text-gray-900 mb-8 tracking-tight">Edit About Page</h3>
        
        {aboutPage ? (
          <form onSubmit={handleUpdateAboutPage} className="space-y-10">
            <div className="grid md:grid-cols-2 gap-8">
              <div className="space-y-2">
                ...
                <input 
                  ...
                  className="w-full px-6 py-4 bg-gray-50/50 border border-gray-100 rounded-2xl focus:ring-4 focus:ring-blue-100 focus:border-blue-500 transition-all font-medium"
                />
              </div>
              <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <textarea 
                ...
                className="w-full px-6 py-4 bg-gray-50/50 border border-gray-100 rounded-2xl focus:ring-4 focus:ring-blue-100 focus:border-blue-500 transition-all font-medium leading-relaxed"
              />
            </div>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="space-y-2">
                  ...
                  <input 
                    ...
                    className="w-full px-6 py-4 bg-blue-50/30 border border-blue-100 rounded-2xl focus:ring-4 focus:ring-blue-100 focus:border-blue-500 transition-all font-medium"
                  />
                </div>
                <div className="space-y-2">
