...
import { 
  Search, Filter, Plus, Edit2, Trash2, Star, Eye, Heart, TrendingUp, X, Upload, Loader2, Image as ImageIcon
} from 'lucide-react';
...
export const ArticleManager: React.FC<ArticleManagerProps> = ({
  ...
  return (
    <div className="animate-in slide-in-from-bottom-4 duration-500 space-y-12">
      ...
      <div className="bg-white rounded-[2rem] border border-gray-100 shadow-sm p-6 flex flex-col md:flex-row items-center gap-4">
        <div className="relative flex-1 group w-full">
          ...
          <input 
            ...
            className="w-full pl-14 pr-6 py-4 bg-gray-50/50 border border-gray-100 rounded-2xl focus:ring-4 focus:ring-blue-100 focus:border-blue-500 transition-all font-medium"
          />
        </div>
      ...
      <p className="text-sm font-bold text-gray-400 ml-4 uppercase tracking-widest mt-8">
      ...
      <div className="bg-white rounded-[2.5rem] border border-gray-100 shadow-sm overflow-hidden">
        {filteredArticles.length > 0 ? (
                ...
                <div className="flex gap-8 max-w-4xl">
                  ...
                  <div className="flex flex-col justify-center">
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <span className="text-xs font-bold text-gray-400 uppercase tracking-tighter shrink-0">{article.date}</span>
                    </div>
                    ...
                    <div className="flex items-center gap-6 text-xs text-gray-400 font-bold uppercase tracking-wider">
                      ...
                      <span className="flex items-center gap-1.5"><Heart className="w-3.5 h-3.5" /> {article.likes}</span>
          ...
          <div className="flex flex-col items-center justify-center py-20 px-4 bg-white rounded-[2.5rem] border border-gray-100 shadow-sm">
            <span className="text-gray-300 mb-4 font-medium">No articles found</span>
          </div>
        )}
      </div>
    </div>
