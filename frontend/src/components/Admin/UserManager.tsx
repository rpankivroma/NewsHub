  ...
  return (
    <div className="animate-in slide-in-from-bottom-4 duration-500 space-y-8">
      ...
      <div className="bg-white rounded-3xl border border-gray-100 shadow-sm p-10">
        <h3 className="text-2xl font-bold text-gray-900 mb-8">User Management</h3>
        ...
        <div className="flex flex-col lg:flex-row gap-4 items-center">
          <div className="relative flex-1 w-full group">
            ...
            <input 
              ...
              className="w-full pl-12 pr-6 py-4 bg-white border border-gray-200 rounded-2xl focus:ring-2 focus:ring-blue-100 focus:border-blue-500 transition-all outline-none text-gray-700 font-medium shadow-sm"
            />
          </div>
